...
public interface Radio {
    ...
    public String guardarEmisoraActual(int numBoton); // Guarda la emisora como favorita en el boton indicado (array de 12 espacios).
    ...
    public void subirEmisora(); // Aumenta la emisora actual en 0.2 si la senal actual es FM, o en 10 si es AM
    public void bajarEmisora(); // Disminuye la emisora actual en 0.2 si la senal actual es FM, o en 10 si es AM
    public float getEmisoraActual(); // Obtener la emisora actual
